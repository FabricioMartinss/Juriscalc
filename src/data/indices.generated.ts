...
export const SERIE_NOVA: SerieIndices = {
  ...
  valores: {
    ...
    2026: [101.977695, 102.181650, 103.039975, 103.493350, 104.414440, 105.061809, 105.492562, 105.555857, 105.133633], // JAN a SET
  },
};
...
export const SERIE_ANTIGA: SerieIndices = {
  ...
  valores: {
    ...
    2026: [101.415524, 101.811044, 102.381185, 103.312853, 104.149687, 104.826659, 104.973416, 104.962918, 104.627036], // JAN a SET
  },
};
...
export const SERIE_IPCA_E: SerieIndices = {
  ...
  valores: {
    ...
    2026: [8.309359, 8.325977, 8.395915, 8.432857, 8.507909, 8.560658, 8.595756, 8.600913, 8.566509], // JAN a SET
  },
};
...
export const INDICES_META = {
  ...
  arquivos: {
    SERIE_NOVA: "https://api.tjsp.jus.br/Handlers/Handler/FileFetch.ashx?codigo=199645",
    SERIE_ANTIGA: "https://api.tjsp.jus.br/Handlers/Handler/FileFetch.ashx?codigo=199643",
    SERIE_IPCA_E: "https://api.tjsp.jus.br/Handlers/Handler/FileFetch.ashx?codigo=199644",
  },
} as const;
